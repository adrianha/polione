...
const schema = z.object({
  ...
  ENTRY_MAX_SPREAD: z.coerce.number().positive().default(0.03),
  ENTRY_DEPTH_PRICE_BAND: z.coerce.number().positive().default(0.02),
  ENTRY_DEPTH_USAGE_RATIO: z.coerce.number().positive().max(1).default(0.6),
...
export const loadConfig = (): BotConfig => {
  ...
  return {
    ...
    entryMaxSpread: parsed.ENTRY_MAX_SPREAD,
    entryDepthPriceBand: parsed.ENTRY_DEPTH_PRICE_BAND,
    entryDepthUsageRatio: parsed.ENTRY_DEPTH_USAGE_RATIO,
